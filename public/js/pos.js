$(document).ready(function() {
    ...
    $('table#pos_table tbody').on('change', 'input.pos_quantity', function() {
        ...
        tr.find("span.max_in_invoice_msg").hide();
        ...
        var max_in_invoice = __read_number(tr.find('input.max_in_invoice'));
        if(max_in_invoice < entered_qty){
            $(this).val(max_in_invoice);
        
            tr.find("span.max_in_invoice_msg").show();
        }
...
function calculate_balance_due() {
    ...
    $("#remaining_due_for_ins").val(bal_due);
}
