...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    Route::any('/lisenceBox', 'LisenceBox\LisenceBoxController@lisenceBox')->name('lisenceBox');
    Route::any('/lisenceBox/update', 'LisenceBox\LisenceBoxController@download_update')->name('lisenceBox.update');
    ...
    Route::resource('contacts', 'ContactController')->middleware('LisenceBox');
    ...
    Route::resource('products', 'ProductController')->middleware('LisenceBox');
    ...
    Route::resource('purchases', 'PurchaseController')->except(['show'])->middleware('LisenceBox');;
    ...
    Route::resource('sells', 'SellController')->except(['show'])->middleware('LisenceBox');;
    Route::get('/sells/for-return', 'SellController@for_return');
    Route::get('/sells/installments/{id}', 'SellController@installments');
    Route::any('/sells/payInstallment', 'SellController@payInstallment');
    ...
    Route::resource('pos', 'SellPosController')->middleware('LisenceBox');;
    Route::get('/litepos/create2/{price_group_id}', 'SellPosController@create2');
    Route::get('/pos/create2/{price_group_id}', 'SellPosController@create2');
    ...
    //Reports...
        Route::any('/reports/stock-compares', 'ReportController@compare_locations');
    ...
    Route::get('/reports/less-trending-products', 'ReportController@getLessTrendingProducts');
    Route::get('/reports/sell-purchase-lines-report', 'ReportController@sell_purchase_lines_report');
    Route::get('/reports/get_product_trans', 'ReportController@get_product_trans');
    ...
    Route::get('/payments/deletepayment/{payment_id}', 'TransactionPaymentController@deletPayment');
    ...
    //Export products
    Route::any('/export-products/export', 'ExportProductsController@export');
    ...
    Route::get('/sell-returns/getinv', 'SellReturnController@get_invoice');
    Route::get('/sell-return-transaction', 'SellReturnController@get_transaction_info');
    ...
    Route::get('/sell-returns/getinv', function(){
        return \Redirect::to('/sells/for-return');
    });
...
Route::middleware(['EcomApi'])->prefix('api/ecom')->group(function () {
   ...
   Route::get('/condidtion-terms',function(){
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/purchase/get_purchase_pay_default', 'PurchaseController@get_purchase_pay_default');
