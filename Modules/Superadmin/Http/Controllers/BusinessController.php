...
class BusinessController extends BaseController
{
   ...
   protected $transactionUtil;
    ...
    public function show($business_id)
    {
        ...
        $product_count=\DB::table('products')->where('business_id',$business_id)->count();
        $sells =  \DB::table('transactions')->where('business_id',$business_id)->where('type','sell')->count();
        $purchase =  \DB::table('transactions')->where('business_id',$business_id)->where('type','purchase')->count();
        $customers =  \DB::table('contacts')->where('business_id',$business_id)->where('type','customer')->count();
        $supliires =  \DB::table('contacts')->where('business_id',$business_id)->where('type','supplier')->count();
        ...
        return view('superadmin::business.show')
            ->with(compact('business', 'created_by','sells','purchase','product_count','customers','supliires'));
    }
