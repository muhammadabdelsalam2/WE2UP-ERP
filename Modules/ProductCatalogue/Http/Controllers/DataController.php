    ...
    public function modifyAdminMenu()
    {
        ...
        if ($is_productcatalogue_enabled) {
            Menu::modify('admin-sidebar-menu', function ($menu) {
                 if (auth()->user()->can('catalouge.show')) {
                ...
                $menu->url(
                        ...
                        ['icon' => 'fa fas fa-qrcode', 'active' => request()->segment(1) == 'product-catalogue', 'style' => config('app.env') == 'demo' ? 'background-color: #ff851b;' : 'background-color: #ff851b']
                    )
                ->order(95);
                  }
            });
