                    	...
                    	<table class="table table-bordered table-striped" id="account_book">
                            ...
                            <tfooter>
                                <tr>
                                   ...
                                   <td><span class="display_currency" id="footer_debit" data-currency_symbol ="true">{{$sum_debit}}</span></td>
                                    <td><span class="display_currency" id="footer_credit" data-currency_symbol ="true">{{$sum_credit}}</span></td>
    ...
    $(document).ready(function(){
        ...
        account_book = $('#account_book').DataTable({
                            ...
                            "fnDrawCallback": function (oSettings) {
                                ...
                                debugger;
                                 var debit = sum_table_col($('#account_book'), 'debit');
                                   // $('#footer_debit').text(debit);
                                     var credit = sum_table_col($('#account_book'), 'credit');
