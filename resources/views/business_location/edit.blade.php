          ...
          <div class="col-sm-12">
            ...
            <table class="table table-condensed table-striped">
              ...
              <tbody>
                ...
                <tr>
                    <td>المشتريات</td>
                    <td>{!! Form::select('default_payment_accounts[' . 'purchase' . '][account]', $accounts, !empty($default_payment_accounts['purchase']['account']) ? $default_payment_accounts['purchase']['account'] : null, ['class' => 'form-control input-sm']); !!}</td>
                </tr>
              </tbody>
            </table>
            </div>
