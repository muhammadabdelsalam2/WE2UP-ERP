			...
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					...
					<div style="font-size:large;">
					    الرصيد المستحق
					    <span id="spplier_balance_due" style="font-weight:800"></span>
					</div>
				</div>
			</div>
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
		...
		<div class="{{$col_class}}">
			<div class="form-group @if($readonly) hide @endif">
				...
				<div class="input-group">
					...
					{!! Form::select("payment[$row_index][account_id]", $accounts, !empty($payment_line['account_id']) ? $payment_line['account_id'] : '' , ['required'=>'required','class' => 'form-control  account-dropdown', 'id' => !$readonly ? "account_$row_index" : "account_advance_$row_index", 'style' => 'width:100%;', 'disabled' => $readonly]); !!}
				</div>
			</div>
		</div>
	@endif
