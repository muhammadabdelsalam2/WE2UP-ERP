    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase_payment.create', in_array('purchase_payment.create', $role_permissions),['class' => 'input-icheck']); !!}
                اضافة دفع شراء
              </label>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
           ...
           <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'sell_payment.create', in_array('sell_payment.create', $role_permissions),['class' => 'input-icheck']); !!}
                اضافة دفع بيع
              </label>
