...
<form action="{{action('StocktackingController@store')}}" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" name="start_date" id="formGroupExampleInput" placeholder="">
  </div>
   <div class="form-group">
    <label for="formGroupExampleInput"> تاريخ الغلق</label>
    <input type="date" class="form-control" name="end_date" id="formGroupExampleInput" placeholder="">
  </div>
  <div class="form-group">
