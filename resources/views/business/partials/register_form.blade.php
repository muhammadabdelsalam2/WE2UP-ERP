...
@if(empty($is_admin))
    <h3 style="background: linear-gradient(-135deg, #c850c0, #4158d0);">@lang('business.business')</h3>
@endif
...
<div class="col-md-6" >
    ...
    <div class="input-group">
        ...
        {!! Form::text('mobile', null, ['class' => 'form-control','placeholder' => __('lang_v1.business_telephone'),'required','id'=>'mo_phone']); !!}
...
<div class="col-md-6">
    @if(!empty($system_settings['superadmin_enable_register_tc']))
        <div class="form-group">
            <label>
                {!! Form::checkbox('accept_tc', 0, true, ['required', 'class' => 'input-icheck']); !!}
