    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                   حالة البيع للعميل الافتراضي 
                  </label>
                  <select class="form-control" name="walk_customer_status">
                      
                      <option <?php if($walk_customer_stauts->contact_status=='active') echo 'selected'; ?> value="active">Active</option>
                      <option <?php if($walk_customer_stauts->contact_status=='inactive') echo 'selected'; ?>  value="inactive">DeActive</option>
                  </select>
                </div>
            </div>
        </div>
