        ...
        <div class="ticket">
                	...
                	@forelse($receipt_details->lines as $line)
	                    <tr class="bb-lg">
	                        <td class="description">
	                        	...
	                        	<div style="display:flex; width: 100%;">
	                        	    	<p class="m-0 mt-5" style="white-space: nowrap;">	                        		عدد :.&nbsp;</p>
	                        		<p class="text-left width-60 quantity m-0 bw">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
	                        			<?php echo number_format($line['quantity'], 0, '.', ''); ?> 
	                        *
	                        	...
	                        	?>
	                        			...
	                        			@if(!empty($line['line_discount']) && $line['line_discount'] != 0)
	                        				خصم  {{$discount_money ?? '' }} <!--{{$line['line_discount']}}-->
								...
								<tr>
									<td>
	                        			...
	                        			<div style="display:flex;">
	                        				...
	                        				<p>
	                        				   {{$modifier['unit_price_before_discount']}}
	                        				</p>
            ...
            <!-- Total Paid-->
				...
				<strong>وفرت : </strong>			 
						...
						<p class="width-50 text-right">
						<strong>EGP	{{$discount_total}} ({{(int)$percent_dis}}%)</strong>
						</p>
					</div>
				@endif
