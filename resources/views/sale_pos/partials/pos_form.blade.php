	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<div style="font-size: large;">
			    الرصيد المستحق
			    <span id="customer_balance_due" style="color: black;font-weight: 800;"></span>
			</div>
		</div>
	</div>
		...
		<div class="form-group">
			<div class="input-group">
				<div class="input-group-btn">
					<button style="margin-right: 114px;"type="button" class="btn btn-default bg-white btn-flat" data-toggle="modal" data-target="#configure_search_modal" title="{{__('lang_v1.configure_product_search')}}"><i class="fa fa-barcode"></i></button>
				</div>
...
<div class="row">
	...
	@endif
	@if(!empty($price_groups) && count($price_groups) > 1 && Request::segment(2) == 'create')
		<div class="col-md-5 col-sm-6">
			<div class="form-group">
				<div class="input-group">
					...
					{!! Form::select('price_group', $price_groups, $selected_price_group, ['class' => 'form-control ', 'id' => 'price_group']); !!}
					<span class="input-group-addon">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead>
				<tr>
					...
					<th class="text-center col-md-2"style="width: 9%;">
						المخزون
					</th>
					<?php } ?>
					<th class="text-center col-md-2"style="width: 15%;">
						@lang('sale.qty')
					</th>
					<th class="text-center col-md-2"style="width: 7%;">
					الوحدة
					</th>
					...
					<th class="text-center col-md-2" style="width: 10%;">
						@lang('sale.subtotal')
					</th>
					<th class="text-right" style="width: 3%;"><i class="fas fa-times" aria-hidden="true"></i></th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
