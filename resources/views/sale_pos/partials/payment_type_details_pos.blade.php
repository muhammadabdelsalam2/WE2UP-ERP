...
<div class="payment_details_div @if( $payment_line['method'] !== 'installment' ) {{ 'hide' }} @endif" data-type="installment" >
	<div class="col-md-4">
		<div class="form-group">
			...
			{!! Form::text("payment[$row_index][prepaid]",null, ['class' => 'form-control', 'placeholder' => __('مبلغ القسط'), 'id' => "remaining_due_for_ins",'disabled']); !!}
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
    ...
    <div class="col-md-4">
		<div class="form-group">
			...
			{!! Form::number("count_months",null, ['class' => 'form-control', 'placeholder' => __('  عدد الاشهر '), 'id' => "count_months"]); !!}
		</div>
	</div>
