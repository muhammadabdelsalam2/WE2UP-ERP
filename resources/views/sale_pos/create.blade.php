...
$(document).ready(function(){
    ...
    $('#cal_earning').click(function(){
         debugger;
        var sum = 0;
        $('.pos_line_purchase_text').each(function(){
          var m= $(this).text();  // Or this.innerHTML, this.innerText
          var d =__currency_trans_from_en(m,false);
            sum +=d;
        });
        var total_earned=parseFloat($("#final_total_input").val()) - parseFloat(sum);
     ...
     $("#prepaid_money").val(get_subtotal());
      ...
      $('#order_tax_modall').change(function() {
          
        //Close modal
        $('div#posEditOrderTaxModal').modal('hide');

        var tax_obj = $('select#order_tax_modall');
    ...
    //====================
    function calculate_billing_details_ins(price_total) {
...
function calculate_balance_due_ins() {
