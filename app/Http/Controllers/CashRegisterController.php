...
class CashRegisterController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('cash_register.register_details')
                    ->with(compact('register_details', 'details', 'payment_types', 'close_time','payements_detail'));
    }
    ...
    public function getRegisterDetails()
    {
        ...
        return view('cash_register.register_details')
                ->with(compact('register_details','expenses','purchases','details', 'payment_types', 'close_time','payements_detail'));
    }
    ...
    public function getCloseRegister($id = null)
    {
        ...
        return view('cash_register.close_register_modal')
                    ->with(compact('register_details', 'details', 'payment_types','payements_detail'));
    }
