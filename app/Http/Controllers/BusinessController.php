...
class BusinessController extends Controller
{
  ...
  "package_id" => "3"
  */
    $request->currency_id="35";
    $request->country='Egypt';
    ...
    $request->landmark='cairo';

    $request->time_zone="Africa/Cairo";

    $request->accounting_method="fifo";
    $request->fy_start_month="1";
...
*/
    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        try {
            ...
            $walk_customer_stauts=\DB::table('contacts')->where('id',$walk_in_customer->id)->first();
            \DB::table('contacts')->where('id',$walk_customer_stauts->id)->update([
                'contact_status'=>$request->walk_customer_status
                ]);
