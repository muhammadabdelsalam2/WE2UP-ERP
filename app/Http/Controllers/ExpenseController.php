    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            //insert in HRM 
            if($request->expense_for>=1){
           $date = \Carbon::now();
            $last_id=\DB::table('essentials_allowances_and_deductions')->insertGetId([
            ...
            \DB::table('essentials_user_allowance_and_deductions')->insert([
            'user_id'=>$request->expense_for,
            'allowance_deduction_id'=>$last_id,
            ]);
            }
            $output = ['success' => 1,
