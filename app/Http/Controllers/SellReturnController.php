...
class SellReturnController extends Controller
{
    ...
    public function get_invoice(){
          return view('sell_return.get_inv_return');
    }
    public function get_transaction_info(Request $request){
        $trans=\DB::table('transactions')->where('invoice_no',$request->inv_id)->first();
        if(!isset($trans->id))
        return redirect()->back()->with('erorr','لايوجد فاتورة بهذا الرقم');
        $re="sell-return/add/".$trans->id;
